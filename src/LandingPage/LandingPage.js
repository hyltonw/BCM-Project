  ...
  function submitForm() {
    if (locationList.length === 1) {
      ...
      for (let i = 0, j = 0; j < locationList.length; i += 3, j++) {
        ...
        if (
          ReviewedFile.keepFile ||
          ReviewedFile.deleteFile ||
          ReviewedFile.sendToIT
        )
          submitFiles(ReviewedFile);
        // deleteFiles(url)
      }
      ...
      {locations === "WARNING" || locations.length === 0 ? (
        <div>
          <div id="warning-container">
            <p>
              It appears your files have been transfered to an administrator.
            </p>
            <p>
              Please contact an administrator if you believe this has been done
              mistakenly.
            </p>
          </div>
        </div>
        ...
        <div id="items">
          <p>
            Hello, {displayName}! Please review the files that may contain
            sensitive information below and select what you would like to do
            with them.
          </p>
          <div class="container">

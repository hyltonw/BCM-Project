...
export async function getAllLocations(url) {
  const locations = await axios.get(
    `https://cors-everywhere-me.herokuapp.com/http://bcmapplication-env.eba-yuipzc2r.us-east-2.elasticbeanstalk.com/api/files/${url}`
...
export function submitFiles(ReviewedFile) {
  axios.put(
    ...
    // ReviewedFile
    `https://cors-everywhere-me.herokuapp.com/http://bcmapplication-env.eba-yuipzc2r.us-east-2.elasticbeanstalk.com/api/files/response`,
    ReviewedFile
  );
  // axios.put(`http://localhost:8080/api/files/response`, ReviewedFile);
  window.location.replace(
    `https://cors-everywhere-me.herokuapp.com/https://main.d31lfvg6uu6z53.amplifyapp.com/submitted`
  );
}
...
export async function getAllUsers() {
  const users = await axios.get(
    ...
    `https://cors-everywhere-me.herokuapp.com/http://bcmapplication-env.eba-yuipzc2r.us-east-2.elasticbeanstalk.com/api/files/allUsers`
  );
...
export async function transferFiles(newOwner, oldOwner) {
  axios.put(
    ...
    // newOwner
    `https://cors-everywhere-me.herokuapp.com/http://bcmapplication-env.eba-yuipzc2r.us-east-2.elasticbeanstalk.com/api/files/${oldOwner}`,
    newOwner
  );
...
export function addTransferLog(transferLog) {
  axios.post(
    ...
    // transferLog
    `https://cors-everywhere-me.herokuapp.com/http://bcmapplication-env.eba-yuipzc2r.us-east-2.elasticbeanstalk.com/api/files/transfer`,
    transferLog
  );
